...
**Holling Type II**
$$
\text{attack rate} = \frac{\alpha N_{prey}}{1 + \alpha N_{prey} h} 
$$

**Holling Type III**
$$
\text{attack rate} = \frac{\alpha N^{c}_{prey}}{1 + \alpha N_{prey}^c h} 
$$
...
$$
\text{attack rate} = \frac{\alpha N_{prey}}{1 + \alpha N_{prey} h_x}, 
\text{where } h_x = 
\begin{cases}
