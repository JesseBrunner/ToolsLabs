...
create one (1) publication-�‐quality plot that best displays the basic trend(s) in the data.  
I am most interested in whether there is a trade-�‐off between the size (Snout�‐vent�‐length; SVL) at metamorphosis and time to metamorphosis, and whether this relationship changes depending on the initial size and the amount of food available.
